 ...
 *              => 사용빈도가 거의 없음
 *     protected: 같은 패키지안에서 접근 가능
 *                상속을 받은 경우에 상속 내린 클래스의 패키지까지 접근 가능
 *                => 사용빈도가 거의 없음
 ...
 *        }
 *     생성자(클래스명과 동일, 리턴형이 없음, 여러 개 사용 가능)
 *       public class A
 *       {
 *           A(){} =. X
 *           public A(){}
 ...
 *            다른 패키지 => import를 사용해서 클래스를 읽어옴
 *                       -------
 *                       라이브러리/사용자 정의 클래스
 *            *** 패키지명은 com(org).회사명.압축 ***
 *            ex) DB연결 => com.sist.dao
 *            
 *   멤버변수: 데이터 보호
 *          --------
 *             |
 *          private => 다른클래스에서는 사용 불가
 *          ------- 변수의 기능
 *                  --------
 *          class A
 *          {
