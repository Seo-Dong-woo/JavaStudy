 ...
 *   1. 데이터 관리
 *      --------
 *       1) 데이터 저장(메모리에 저장, 파일 저장, RDBMS 저장)
 *                              ----------------- 영구적인 저장
 *          = 한 개 저장: 변수
 *          --------------
 *          = 같은 데이터 저장: 배열
 ...
 *         ------
 *         => 클래스명과 동일(대소문자 구분)
 *   한 파일 안에 여러 개의 클래스를 사용할 수 있음
 *   ----------------------------------
 *   class A
 *   public class B
 *   -------------- public class는 한 파일 안에 한 개만 사용 가능
 *   
 *   class A
 *   class B
 *   ------- 저장명은 A.java, B.java
 *   ------- 일밪 => 저장명은 main이 있는 클래스를 저장명으로 설정
 *   
 *   *** 같은 폴더(src)
 *   class A
...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		/*for(int i=0;i<3;i++)
		{
			...
			eng[i]=scan.nextInt();
			System.out.print((i+1) + "번째 수학어 입력: ");
			math[i]=scan.nextInt();
		}
		// 출력
		for(int i=0;i<3;i++)
