 ...
 *                = 한 개만 상속 가능(단일 상속)
 *                = 형식
 *                  A extends B => B가 가지고 있는 모든 것을 가져옴
 ...
 *                                    class B extends A
 *                                    
 *                                    B b=new B(); ==> A클래스 메모리 할당 => B 클래스 메모리 할당
 *                                    
 *                                    => 스프링에서는 상속 개념이 거의 없음(일반 클래스로 사용 => 처리)
 *                                                                ------------- POJO
 *                                 => 자바의 모든 클래스
 *                                         --------
 *                                           | 라이브러리/사용자 정의 클래스 => Object 클래스로부터 상속을 받음
 *                                           | class A extends Object
 *                                                     -------------- 생략 가능 => Object가 가지고 있는 모든 기능을 사용할 수 있음
 *                                    
 *               하위 클래스   상위 클래스
 *               상속 내리는 클래스: 슈퍼 클래스, 상위 클래스, 베이스 클래스
 *                              부모 클래스
 *               상속을 받는 클래스: 서브 클래스, 하위 클래스, 파생 클래스
 *                              자식 클래스
