...
// B클래스는 A클래스에 있는 모든 것을 사용할 수 있음(a, b, aaa())
// A클래스는 B클래스에 있는 모든 것을 사용할 수 없음(a, b, aaa())
public class MainClass2 {
	...
	public static void main(String[] args) {
		 ...
		 *       class B extends A
		 *       B b=new B();
		 *        상속 제외 => static, private, 생성자, 초기화 블록
		 *                  상위 클래스는 공통적으로 사용하는 메소드, 변수
		 *       A => 여러 개를 한 개의 클래스로 제어
		 */
		 ...
		 *      *** 단일 상속만 가능
		 *      
		 *      상위 클래스는 하위 클래스가 가지고 있는 변수, 메소드 사용 불가
		 *      하위 클래스는 상위 클래스가 가지고 있는 변수, 메소드 사용 가능
		 *                ==> 변수(static) 상속은 아님. 사용은 가능
		 *                ==> 공통으로 사용 가능
		 *      객체 생성
		 *      하위 클래스로 객체 생성
		 *      class A
		 ...
		 *      
		 *      => B b=new B();
		 *      => A a=new B(); => 여러 개의 클래스를 한 개로 묶어서 사용
		 *      -----------------
		 *      => A bb=new B(); // 형변환 시에는 생성자 부분을 먼저 써줘야 함
		 *      => B cc=(A)bb;
		 *      
		 *      class 동물
		 *      class 사람 extends 동물
