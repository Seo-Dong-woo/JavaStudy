 ...
 *      = 미완성 클래스(메소드를 구현하지 않는 경우) => 선언만 됐을 때
 ...
 *       class Game2 extends MousListener
 *       class Game3 extends KeyListener
 *       
 *       class Game4 extends Game1
 *       class Game5 extends Game4
 *       
 *       class Game implements ActionListner, MouseListener, KeyListener
 *       => 추상 클래스 보완
 *          1) 다중 상속
 *          2) 구현이 안된 메소드만 사용
 *          3) 변수 => 상수
 *          4) 기본 => 다른 클래스에 영향이 없게 만듬
 */
//추상클래스
import java.util.*;
