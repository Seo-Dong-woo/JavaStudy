 ...
 *               }catch(예외처리 클래스)
 *               {
 *                   => try안에 있는 명령문에서 오류 발생 시 예외처리/복구
 *               } ==> 여러 개 사용 가능
 *               finally ==> 생략(필요한 경우에만)
 *               {
 ...
 *               
 *               에러 없을 시
 *               1 => 2 => 3 => 4 => 5 => 7 => 8 // try가 정상이면 catch를 수행하지 않음
 *                                                  if~else
 *               에러 발생
 *               1 => 2 => 3 => 6 => 7 => 8 // try문에서 에러 아래 부분은 건너뜀
 *               
 *               try
 *               {
 *                   문장 1
 ...
 *                               ----------------------- 여기서 먼저 에러 발생 // arr[2](없는 메모리여서 에러발생)에 대입하기 전에 에러 출력
 *                        
 *               }catch(A) else if
 *               {
...
public class MainClass_2 {
	...
	public static void main(String[] args) {
		...
		FileReader fr=null; // 초기값을 줘야 함. 안주면 에러
		try
		{
