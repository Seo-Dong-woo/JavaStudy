...
public class BoardListPanel extends JPanel implements ActionListener{
	...
	public BoardListPanel(ControllPanel cp)
	{
		...
		tabel.getColumn("번호").setPreferredWidth(30);
		tabel.getColumn("제목").setPreferredWidth(400);
		tabel.getColumn("이름").setPreferredWidth(100);
		tabel.getColumn("작성일").setPreferredWidth(150);
		tabel.getColumn("조회수").setPreferredWidth(50);
